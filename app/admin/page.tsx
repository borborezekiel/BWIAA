...
import {
  ...
  Heart, Receipt, UserPlus, TrendingDown, ArrowRight, ChevronDown, ChevronUp, Clock, Info, AlertTriangle, Globe, Edit2, AlertCircle,
} from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="font-black uppercase italic leading-tight text-sm">
              ...
              {myRole && myRole !== 'admin' && !isHeadAdmin && (
                <span className="bg-red-600 text-white text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full ml-2">
                  {myRole.replace(/_/g,' ')}
                </span>
              )}
              </span>
